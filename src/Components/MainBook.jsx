...
const API_ORDERS_URL = "https://api.drboahemaantim.com/api/books/order";
const API_CONFIRM_URL = "https://api.drboahemaantim.com/api/books/confirm";

export default function MainBook({
    productId = "bth-book-001",
    productTitle = "Beyond The Hustle Book",
    amountPesewas = 10000, // GHS * 100
}) {
    // Form state
        ...
        <div className="min-h-screen grid md:grid-cols-2 bg-gray-100 mt-[150px] md:mt-[100px]">
            <div className="hidden md:flex flex-col items-center justify-center bg-[#1C2237]">
                <h2 className="text-3xl font-bold font-openSans mb-6 text-center text-[#D95B24]">
                    Complete Your Payment for Beyond The Hustle</h2>
