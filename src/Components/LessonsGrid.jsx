    ...
    return (
        <section className="w-full py-12 md:py-16 lg:py-24 bg-[#1C2237] text-gray-200">
            <div className="container mx-auto text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 my-12 px-4 lg:px-14 mx-auto">
                ...
                <Link to='/excerpts' className="mt-12 px-8 py-3 text-lg bg-[#D95B24] hover:bg-orange-700 text-white shadow-lg">
                    View More
                </Link>
